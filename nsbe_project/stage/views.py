...
class ChangePassword(SuccessMessageMixin, PasswordResetView):
    template_name = 'stage/change_password.html'
    email_template_name = 'stage/change_password_email.html'
    subject_template_name = 'stage/change_password_subject.html'
    success_message = "We've emailed you instructions for setting your password, " \
                      "if an account exists with the email you entered. You should receive them shortly." \
                      " If you don't receive an email, " \
                      "please make sure you've entered the address you registered with, and check your spam folder."
    success_url = reverse_lazy('stage-index')
