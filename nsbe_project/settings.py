...
SECRET_KEY = env('SECRET_KEY', default="django-insecure-lo=f%zdflhdk2^(dw_s*i=736_(&q4fdvl&kuc+kh*(17k1lu&")
...
# Email settings
EMAIL_BACKEND = 'stage.backends.email_backend.CustomEmailBackend'
EMAIL_HOST = env('EMAIL_HOST', default='smtp.gmail.com')
EMAIL_PORT = env('EMAIL_PORT', default=587)
EMAIL_USE_TLS = env.bool('EMAIL_USE_TLS', default=True)
EMAIL_HOST_USER = env('EMAIL_HOST_USER', default='paccysan@gmail.com')
EMAIL_HOST_PASSWORD = env('EMAIL_HOST_PASSWORD', default='irvrmwdiponolvga')
DEFAULT_FROM_EMAIL = env('DEFAULT_FROM_EMAIL', default='paccysan@gmail.com')
